...
export function app5 () {
    ...
    const Cliente3 = new Cliente ("Eduardo", "777.222.333-00","11 98866-5544", true);
    const Conta3 = new contaPoupanca (0, 0, Cliente3, "10500", "10501");
    ...
    Conta3.calcularRendimento(Conta3.saldo); //verificar porque não funciona
    ...
    //solução provisória para juros simples
}